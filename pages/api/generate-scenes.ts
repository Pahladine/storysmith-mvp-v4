...
async function ollamaScenes(
  ...
  const user = [
    ...
    sceneLines,
    "",
    "Write each scene as 150Ã¢â‚¬â€œ250 words, cozy and age-appropriate.",
    ...
    "ILLUSTRATION PROMPT TEMPLATE: return one concise prompt per scene with this structure:",
    "Subject: who is present and what they are doing; include key props.",
    "Setting: place and time of day; include 2-3 visual details.",
    "Composition: camera distance + framing (e.g., medium shot, eye level).",
    "Lighting/Color: warm storybook palette, soft light.",
    "Mood: gentle, safe, curious.",
    "Consistency: keep hero and companion features and outfits consistent across all scenes.",
    "Avoid: scary imagery, weapons, injuries, and any written text in the image.",
